...
enum TypeId
{
    ...
    TypeIds_Promise = 73,
    TypeIds_SharedArrayBuffer = 74,

    TypeIds_WebAssemblyModule = 75,
    TypeIds_WebAssemblyInstance = 76,
    TypeIds_WebAssemblyMemory = 77,
    TypeIds_WebAssemblyTable = 78,

    TypeIds_LastBuiltinDynamicObject = TypeIds_WebAssemblyTable,
    TypeIds_GlobalObject = 79,
    TypeIds_ModuleRoot = 80,
    TypeIds_LastTrueJavascriptObjectType = TypeIds_ModuleRoot,

    TypeIds_HostObject = 81,
    TypeIds_ActivationObject = 82,
    TypeIds_SpreadArgument = 83,
    TypeIds_ModuleNamespace = 84,
    TypeIds_ListIterator = 85,
    TypeIds_ExternalIterator = 86,
